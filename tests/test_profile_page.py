...
class TestProfilePage:
    ...
    def test_link_profile_is_opened_profile_page(self, driver):
        ...
        assert profile_page.check_form_login() and profile_page.get_current_url() == LOGIN_PAGE_URL
    ...
    def test_button_history_is_opened_order_history(self, authorization):
        ...
        assert profile_page.check_selected_history() and profile_page.get_current_url() == ORDER_HISTORY_PROFILE_PAGE_URL
